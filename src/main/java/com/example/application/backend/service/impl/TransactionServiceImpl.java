...
public class TransactionServiceImpl implements TransactionService {
    ...
    /**
     * Get transactions by bankaccount ID in a data range - Service
     *
     * @param idBankAccount id bankaccount id of transactions : Long
    ...
    public TransactionsBankAccountResponse findAllTransactionsByDateRangeByIdBankAccount(Long idBankAccount, Map<String, String> map1) {
        try {
            ...
            if (map1.get("startDate") != null && map1.get("endDate") != null) {
                return this.transactionDAO.findAllTransactionsByDateRangeByIdBankAccount(idBankAccount, map1);
            }

            return new TransactionsBankAccountResponse("-404");
